...
OUTPUT_FOLDERS = ['alphamatting/output_lowres_new42_2/Trimap1', 'alphamatting/output_lowres_new42_2/Trimap2', 'images/alphamatting/output_lowres_new42_2/Trimap3', ]
...
if __name__ == '__main__':
    ...
    # model.eval()
    checkpoint = 'checkpoints_1/checkpoint_42_0.055780417797601935.tar'
    checkpoint = torch.load(checkpoint)
