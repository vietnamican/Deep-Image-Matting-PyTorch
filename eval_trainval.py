...
OUTPUT_FOLDERS = ['alphamatting/output_lowres_new20_2/Trimap1', 'alphamatting/output_lowres_new20_2/Trimap2', 'images/alphamatting/output_lowres_new20_2/Trimap3', ]
...
if __name__ == '__main__':
    ...
    # model.eval()
    checkpoint = 'checkpoints_1/checkpoint_20_0.058205759744547926.tar'
    checkpoint = torch.load(checkpoint)
