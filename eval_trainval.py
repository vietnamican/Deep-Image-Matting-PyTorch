...
OUTPUT_FOLDERS = ['alphamatting/output_lowres_new20/Trimap1', 'alphamatting/output_lowres_new20/Trimap2', 'images/alphamatting/output_lowres_new20/Trimap3', ]
...
if __name__ == '__main__':
    ...
    # model.eval()
    checkpoint = 'checkpoints_1/checkpoint_20_0.05332112515858118.tar'
    checkpoint = torch.load(checkpoint)
