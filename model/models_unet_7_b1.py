...
class DIMModel(nn.Module):
    def __init__(self):
        ...
        self.short1 = Sequential(
            Block(4, 64, 1, 1, 0), Block(64, 64, 1, 1, 0)
        )
        ...
        self.down3_conv1 = Block(128, 256, 3, 2, 1, with_depthwise=False)  # 40
        self.down3_conv2 = Block(256, 256, 3, 1, 1, with_depthwise=False)  # 40
        self.down3_conv3 = Block(256, 256, 3, 1, 1, with_depthwise=False)  # 40

        self.short4 = Sequential(
            Block(256, 256, 1, 1, 0), Block(256, 256, 1, 1, 0)
        )

        self.down4_conv1 = Block(256, 512, 3, 2, 1, with_depthwise=False)  # 20
        self.down4_conv2 = Block(512, 512, 3, 1, 1, with_depthwise=False)  # 20
        self.down4_conv3 = Block(512, 512, 3, 1, 1, with_depthwise=False)  # 20

        self.short5 = Sequential(
            Block(512, 512, 1, 1, 0), Block(512, 512, 1, 1, 0)
        )

        self.down5_conv1 = Block(512, 1024, 3, 2, 1)  # 10
        self.down5_conv2 = Block(1024, 1024, 3, 1, 1)  # 10
        self.down5_conv3 = Block(1024, 1024, 3, 1, 1)  # 10
        ...
        self.up4_conv3 = Block(256, 256, 3, 1, 1)  # 40

        self.up3_conv1 = UpBlock(2, 256, 128, 3, 1, 1)  # 80
        self.up3_conv2 = Block(128, 128, 3, 1, 1)  # 80
        self.up3_conv3 = Block(128, 128, 3, 1, 1)  # 80
