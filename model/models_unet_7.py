...
class DIMModel(nn.Module):
    def __init__(self):
        ...
        self.short1 = Sequential(
            Block(4, 32, 3, 1, 1), Block(32, 32, 3, 1, 1)
        )

        self.down1_conv1 = Block(4, 32, 3, 2, 1, with_depthwise=False)  # 160 32
        self.down1_conv2 = Block(32, 32, 3, 1, 1, with_depthwise=False)  # 160 32

        self.short2 = Sequential(
            Block(32, 32, 3, 1, 1), Block(32, 32, 3, 1, 1)
        )

        self.down2_conv1 = Block(32, 64, 3, 2, 1, with_depthwise=False)  # 80
        self.down2_conv2 = Block(64, 64, 3, 1, 1, with_depthwise=False)  # 80

        self.short3 = Sequential(
            Block(64, 64, 3, 1, 1), Block(64, 64, 3, 1, 1)
        )

        self.down3_conv1 = Block(64, 128, 3, 2, 1, with_depthwise=False)  # 40
        self.down3_conv2 = Block(128, 128, 3, 1, 1, with_depthwise=False)  # 40
        self.down3_conv3 = Block(128, 128, 3, 1, 1, with_depthwise=False)  # 40

        self.short4 = Sequential(
            Block(128, 128, 3, 1, 1), Block(128, 128, 3, 1, 1)
        )

        self.down4_conv1 = Block(128, 256, 3, 2, 1, with_depthwise=False)  # 20
        self.down4_conv2 = Block(256, 256, 3, 1, 1, with_depthwise=False)  # 20
        self.down4_conv3 = Block(256, 256, 3, 1, 1, with_depthwise=False)  # 20

        self.short5 = Sequential(
            Block(256, 256, 3, 1, 1), Block(256, 256, 3, 1, 1)
        )

        self.down5_conv1 = Block(256, 512, 3, 2, 1)  # 10
